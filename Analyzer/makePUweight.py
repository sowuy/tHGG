...
def main():
    ...
    datapufile = ROOT.TFile.Open('/home/ucl/cp3/swuycken/scratch/CMSSW_10_5_0/src/tHGG/Analyzer/data/PileUp.root')
    ...
    mcfile = ROOT.TFile.Open("/home/ucl/cp3/swuycken/scratch/CMSSW_10_5_0/src/tHGG/Analyzer/data/MCPileUp.root","update")
    mchist.Write()
    puhist.Write()
    print puweightsum
    print orgweightsum
